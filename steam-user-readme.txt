...
console.log(SteamUser.formatCurrency(12345, SteamUser.ECurrencyCode.JPY)); // ┬е 12345
console.log(SteamUser.formatCurrency(123.45, SteamUser.ECurrencyCode.EUR)); // 123,45тВм
```
